...
namespace Store.Tests.Entities
{
    ...
    {
        private readonly Customer _customer = new Customer("Mariana", "mariana.tmarinho@gmail.com");
        ...
        [TestMethod]
        [TestCategory("Domain")]
        public void Dado_um_novo_item_com_quantidade_zero_ou_menor_este_nao_deve_ser_add()
        {
             var order = new Order(_customer, 0, null);
